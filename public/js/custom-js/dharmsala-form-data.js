function preview() {  
   ...
   var Entity_Ward = $('#EntityWard').val();
    ...
    var No_Of_Entry_Gate= $('#NoOfEntryGate').val();
	var No_Of_Entry_Gate_label = "NoOfEntryGate";
    var No_Of_Entry_Gate_data = `<div class="form-row"><div class="form-group col-md-6"><label><strong>${No_Of_Entry_Gate_label} <strong></label><input type="text" class="form-control" value="${No_Of_Entry_Gate}" disabled /></div></div>`;
    ...
    //Final data Table 
    var data = applicant_data+father_data+mobile_data+ email_data+Residence_Address_data+Ward_No_data+Permanent_Address_data+Ward_No1_data+License_Year_data+Entity_Name_data+Entity_Address_data+ Entity_Ward_data+Holding_No_data+License_No_data+Longitude_data+Latitude_data+Organization_Type_data+Land_Deed_Type_data+Water_Supply_Type_data+Electricity_Type_data+Security_Type_data+CCTV_Camera_No_data
    +No_Of_Beds_data+No_Of_Rooms_data+No_Of_Fire_Extinguishers_data+No_Of_Entry_Gate_data+No_Of_Exit_Gate_data+No_Of_Two_Wheelers_Parking_data+No_Of_Four_Wheelers_Parking_data+Aadhar_No_data+PAN_No_data ;
