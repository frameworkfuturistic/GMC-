...
class CreateHoardingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('hoardings', function (Blueprint $table) {
            $table->increments('HoardingID');
            $table->string('RenewalID', 15)->nullable();
            $table->date('ApplicationDate')->nullable();
            $table->string('PermissionFrom', 10)->nullable();
            $table->string('PermissionTo', 10)->nullable();
            ...
            $table->string('PermitIssueDate', 10)->nullable();
            $table->string('PermitExpirationDate', 20)->nullable();
