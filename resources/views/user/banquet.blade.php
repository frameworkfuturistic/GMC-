                ...
                <div role="tabpanel" class="tab-pane active" id="tab1" aria-expanded="true" aria-labelledby="base-tab1">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <!-- form -->
                            <form action="{{ url('rnc/addBanquet') }}" method="POST" enctype="multipart/form-data" id="formSubmit">
                                @csrf
                                    ...
                                    <table id="myTable" class="table table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control" id="Father" name="Father" type="text" value="">
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control" id="Mobile" name="Mobile" type="text" value="{{session('mobile')}}" readonly>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control" id="ResidenceAddress" name="ResidenceAddress" type="text" value="">
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="spin-separator">:</td>
                                            <td>
                                                <input class="form-control" type="number" id="CCTVNo" name="CCTVNo">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="spin-separator">:</td>
                                            <td>
                                                <input class="form-control" type="number" id="FireExtinguishersNo" name="FireExtinguishersNo">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="spin-separator">:</td>
                                            <td>
                                                <input class="form-control" type="number" id="EntryGatesNo" name="EntryGatesNo">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="spin-separator">:</td>
                                            <td>
                                                <input class="form-control" type="number" id="ExitGatesNo" name="ExitGatesNo">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="spin-separator">:</td>
                                            <td>
                                                <input class="form-control" type="number" id="TwoWheelersParkingSpace" name="TwoWheelersParkingSpace">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="spin-separator">:</td>
                                            <td>
                                                <input class="form-control" type="number" id="FourWheelersParkingSpace" name="FourWheelersParkingSpace">
                                            </td>
                                        </tr>
                                        <tr>
...
<script src="js/custom-js/banquet-form-data.js"></script>
@endsection 
