                                    ...
                                    <table id="myTable" class="table table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="spin-valuearea form-control text-box single-line" id="ResidenceAddress" name="ResidenceAddress" type="text" value="">
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="spin-separator">:</td>
                                                <td>
                                                    <input class="spin-valuearea form-control text-box single-line" id="PermanentAddress" name="PermanentAddress" type="text" value="">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="spin-label">Ward No<span class="spin-separator spin-star">*</span></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="spin-separator">:</td>
                                                <td>
                                                    <input class="spin-valuearea form-control text-box single-line" id="AadharNo" name="AadharNo" type="text" value="">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
