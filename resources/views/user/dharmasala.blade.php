                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="card-header card-bg">
                                <div class="card-title my-card-title">DHARAMSALA REGISTRATION APPLICATION</div>
                            </div>
                            <!-- form tag -->

                            <!-- form -->
                            <form action="{{ url('api/rnc/addDharmasala') }}" method="POST" enctype="multipart/form-data">
                                @csrf
