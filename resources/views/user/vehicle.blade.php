                ...
                <div role="tabpanel" class="tab-pane active" id="tab1" aria-expanded="true" aria-labelledby="base-tab1">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <!-- form -->
                            <form action="{{ url('api/rnc/addVehicleAdvet') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="4" class="spin-label" style="width:100%;"><span>Upload Vehicle Photograph</span><input name="VehiclePhotoPath"
                                        ...
                                        <tr>
                                            <td colspan="4" class="spin-label" style="width:100%;">
                                                <span>Upload Driving License</span><input id="DrivingLicensePath" name="DrivingLicensePath"
                                                    type="file" accept="application/pdf,image/*" style="width:100%;">
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td colspan="4" class="spin-label" style="width:100%;">
                                                <span>Upload Insurance Photo</span><input id="InsurancePhotoPath"
                                                    name="InsurancePhotoPath" type="file" accept="application/pdf,image/*"
                                                    style="width:100%;">
                                            </td>
                                        </tr>
