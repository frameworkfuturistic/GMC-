                ...
                <div class="tab-pane" id="tab2" aria-labelledby="base-tab2" aria-expanded="false">
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <!-- comments -->
                            <!-- form -->
                            <form class="form mb-top" method="POST" action="{{url('rnc/banquetWorkflow/'.$banquet->id)}}" id="forwardTo1">
                                @method('PUT')
                                @csrf
                                <div class="form-body">
                                    <input type="hidden" value="{{$banquet->id}}" id="id" name="id">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="AppStatus" name="AppStatus" value="{{$banquet->ApplicationStatus}}">
                                    </div>
