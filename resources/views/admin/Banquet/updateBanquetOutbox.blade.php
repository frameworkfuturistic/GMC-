                ...
                <div role="tabpanel" class="tab-pane active" id="tab1" aria-expanded="true" aria-labelledby="base-tab1">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <!-- form -->
                            <form action="{{url('api/rnc/updateBanquet/'.$banquet->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf 
                                @method('put')
                                            ...
                                            <td>
                                                <select class="form-control" id="HallType" name="HallType">
                                                    ...
                                                    @foreach($hallTypes as $hallType)
                                                        <option value="{{$hallType->StringParameter}}">{{$hallType->StringParameter}}</option>
                                                    @endforeach
                                                </select>
                                            </td>
                                        </tr>
