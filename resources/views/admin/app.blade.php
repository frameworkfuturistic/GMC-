    ...
    <div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
        ...
        <div class="main-menu-content">
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                ...
                <li class="nav-item"><a href="index.html"><i class="{{$parent->Icon}}"></i><span data-i18n="nav.dash.main" class="menu-title">{{$parent->MenuString}}</span></a>
                    <ul class="menu-content">
                        @foreach($childs as $child)
                        @if($child->ParentSerial==$parent->Serial)
                        <li id="{{$child->ActiveName}}"><a href="{{$child->Route}}" data-i18n="nav.dash.main" class="menu-item">{{$child->MenuString}}</a>
                        </li>
                        @endif
                        @endforeach
                    </ul>
