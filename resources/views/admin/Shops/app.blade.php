    ...
    <div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
        ...
        <div class="main-menu-content">
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                <li class="nav-item"><a href=""><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Collection Summary</span></a>
                    <ul class="menu-content">
                        <li @yield('shopSummaryActive')><a href="/shopSummary" data-i18n="nav.dash.main" class="menu-item">Collection Summary</a>
                        </li>
                    </ul>
                </li>
            </ul>
