            ...
            <div class="navbar-header">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item"><a href="api/rnc/dashboard" class="navbar-brand nav-link">
                            <h3 class="rmc_hoarding brand-logo">RMC Hoarding</h3>
                        </a></li>
                ...
                <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item hidden-sm-down"><a href="{{ url()->previous() }}"
                                class="nav-link nav-link-expand"><i class="ficon icon-arrow-circle-left"></i></a></li>
                            ...
                            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                                ...
                                <li class="list-group scrollable-container"><a href="javascript:void(0)"
                                        ...
                                        <div class="media">
                                            <div class="media-left"><span
                                                    class="avatar avatar-sm avatar-busy rounded-circle"><img
                                                        src="admin_dash/app-assets/images/portrait/small/avatar-s-2.png"
                                                        alt="avatar"><i></i></span></div>
                                            <div class="media-body">
                                        ...
                                        <div class="media">
                                            <div class="media-left"><span
                                                    class="avatar avatar-sm avatar-online rounded-circle"><img
                                                        src="admin_dash/app-assets/images/portrait/small/avatar-s-3.png"
                                                        alt="avatar"><i></i></span></div>
                                            <div class="media-body">
                                        ...
                                        <div class="media">
                                            <div class="media-left"><span
                                                    class="avatar avatar-sm avatar-away rounded-circle"><img
                                                        src="admin_dash/app-assets/images/portrait/small/avatar-s-6.png"
                                                        alt="avatar"><i></i></span></div>
                                            <div class="media-body">
        ...
        <div class="main-menu-content">
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                <li class="nav-item"><a href=""><i class="icon-home3"></i><span data-i18n="nav.dash.main"
                            class="menu-title">Collection Summary</span></a>
                    <ul class="menu-content">
                        <li @yield('shopSummaryActive')><a href="/shopSummary" data-i18n="nav.dash.main"
                                class="menu-item">Collection Summary</a>
                        </li>
                    </ul>
                </li>
            </ul>
