                ...
                <div role="tabpanel" class="tab-pane active" id="tab1" aria-expanded="true" aria-labelledby="base-tab1">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <!-- form -->
                            <form action="{{url('api/rnc/updatePrivateLand/'.$land->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf 
                                @method('put')
                                            ...
                                            <td>
                                                <select class="form-control" id="InstallationLocation" name="InstallationLocation">
                                                    ...
                                                    @foreach($locations as $location)
                                                        <option value="{{$location->StringParameter}}">{{$location->StringParameter}}</option>
                                                    @endforeach
                                                </select>
                                            </td>
                                        </tr>
