                ...
                <div role="tabpanel" class="tab-pane active" id="tab1" aria-expanded="true" aria-labelledby="base-tab1">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <!-- form -->
                            <form action="{{url('api/rnc/updatePrivateLand/'.$land->id)}}" method="POST"
                                    ...
                                    <tbody>
                                        ...
                                        <tr colspan="4" class="spin-label">
                                            <td>
                                                ...
                                                @if($land->CurrentUser==$workflowInitiator->Initiator)
                ...
                <div class="tab-pane" id="tab2" aria-labelledby="base-tab2" aria-expanded="false">
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <!-- comments -->
                            <form action="{{url('api/rnc/LandInboxComment/'.$land->id)}}" method="POST" id="commentTo">
                                @method('POST')
                                @csrf
                            ...
                            <form class="form mb-top" method="POST"
                                action="{{url('api/rnc/PrivateLandWorkflow/'.$land->id)}}" id="forwardTo1">
                                @method('PUT')
                                @csrf
                                <div class="form-body">
                                    <input type="hidden" value="{{$land->id}}" id="id" name="id">
                                    ...
                                    @if($land->CurrentUser==$workflowInitiator->Finisher)
                                    <div class="form-group">
