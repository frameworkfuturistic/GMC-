                ...
                <div role="tabpanel" class="tab-pane active" id="tab1" aria-expanded="true" aria-labelledby="base-tab1">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <!-- form -->
                            <form action="{{url('api/rnc/updateVehicle/'.$vehicle->id)}}" method="POST"
                ...
                <div class="tab-pane" id="tab2" aria-labelledby="base-tab2" aria-expanded="false">
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <!-- comments -->
                            <form action="{{url('api/rnc/VehicleInboxComment/'.$vehicle->id)}}" method="POST"
                                id="commentTo">
                                @method('POST')
                                @csrf
                            ...
                            <form class="form mb-top" method="POST"
                                action="{{url('api/rnc/vehicleWorkflow/'.$vehicle->id)}}" id="forwardTo">
                                @method('PUT')
                                @csrf
                                <div class="form-body">
                                    <input type="hidden" value="{{$vehicle->id}}" id="id" name="id">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="AppStatus" name="AppStatus"
                                            value="{{$vehicle->ApplicationStatus}}">
                                    </div>
