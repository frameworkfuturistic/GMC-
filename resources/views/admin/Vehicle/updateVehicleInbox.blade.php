                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="4" class="spin-label" style="width:100%;"><span>Upload Vehicle
                                                    Photograph</span><input name="VehiclePhotoPath" id="VehiclePhotoPath" type="file" accept="application/pdf,image/*" style="width:100%;">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="4" class="spin-label" style="width:100%;"><span>Upload
                                        ...
                                        <tr colspan="4" class="spin-label">
                                            <td>
                                                ...
                                                @if($vehicle->CurrentUser==$workflowInitiator->Initiator)
                ...
                <div class="tab-pane" id="tab2" aria-labelledby="base-tab2" aria-expanded="false">
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <!-- comments -->
                            <form action="{{url('rnc/VehicleInboxComment/'.$vehicle->id)}}" method="POST" id="commentTo">
                                @method('POST')
                                @csrf
                                <div class="form-group mb-top">
                                    <input type="hidden" value="{{$vehicle->RenewalID}}" id="RenewalID" name="RenewalID">
                            ...
                            <!-- comments -->
                            <!-- form -->
                            <form class="form mb-top" method="POST" action="{{url('rnc/vehicleWorkflow/'.$vehicle->id)}}" id="forwardTo">
                                @method('PUT')
                                @csrf
                                <div class="form-body">
                                    <input type="hidden" value="{{$vehicle->id}}" id="id" name="id">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="AppStatus" name="AppStatus" value="{{$vehicle->ApplicationStatus}}">
                                    </div>

                                    @if($vehicle->CurrentUser==$workflowInitiator->Finisher)
                                    <div class="form-group">
                                        <label for="complaintinput2">Update Status</label>
                                        <select class="form-control" id="UpdateStatus" name="UpdateStatus">
                                            @if($vehicle->Approved=='-1')
                                            <option value="Approved" selected>Approve</option>
                                            @endif
                                            @if($vehicle->Rejected=='-1')
                                            <option value="Rejected" selected>Reject</option>
                                            @endif
                                            @if($vehicle->Pending=='-1')
...
<script>
    ...
    $(function() {
        $('#forwardTo').submit(function(e) {
            var targetform = $('#forwardTo');
            var murl = targetform.attr('action');
            var mdata = $("#forwardTo").serialize();
            e.preventDefault();
            $('#loaderbody').show();
