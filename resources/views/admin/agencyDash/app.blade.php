...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="admin_dash/assets/css/style1.css">
    <!-- END Custom CSS-->
...
<body data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar">
        ...
        <div class="navbar-wrapper">
            <div class="navbar-header">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item"><a href="api/rnc/dashboard" class="navbar-brand nav-link">
    ...
    <div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
        ...
        <div class="main-menu-content">
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                <li class="nav-item"><a href=""><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Dashboard</span><span class="tag tag tag-warning tag-pill float-xs-right mr-2">1</span></a>
                    <ul class="menu-content">
                        <li @yield('activeDash')><a href="rnc/dashboard" data-i18n="nav.dash.main" class="menu-item">Dashboard 1</a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item @yield('activeNewHoarding')">
                    <a href="rnc/newHoarding">
    ...
    <footer class="footer footer-static footer-light navbar-border">
        <p class="clearfix text-muted text-sm-center mb-0 px-2"><span class="float-md-left d-xs-block d-md-inline-block">Copyright &copy; 2022 <a href="" target="_blank" class="text-bold-800 grey darken-2">RMC Ranchi Municipal Corporation</a>, All rights reserved.
            </span><span class="float-md-right d-xs-block d-md-inline-block">Hand-crafted & Made with <i class="icon-heart5 pink"></i> <strong>Framework Futuristics Private Ltd</strong></span></p>
    </footer>
