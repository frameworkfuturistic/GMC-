                ...
                <div class="tab-content px-1 pt-1">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="tab1" aria-expanded="true"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="card-header card-bg">
                                    <div class="card-title my-card-title">Payment Details</div>
                                </div>
                                <!-- form -->
                                <!-- form -->
                                <div class="table-responsive">
                                    <form action="{{url('rnc/updatePmt/'.$SelfAds->id)}}" method="POST">
                                        ...
                                        <table id="myTable" class="table table-bordered">
                                            <tbody>
                                                <tr>
                                                    <td class="spin-label">Payment Date <span
                                                            class="spin-separator spin-star">*</span></td>
                                                ...
                                                <tr>
                                                    <td class="spin-label">Payment Mode <span
                                                            class="spin-separator spin-star">*</span></td>

                                                    <td>
                                                        <select class="form-control" id="pmtMode" name="pmtMode">
                                                ...
                                                <tr>
                                                    <td class="spin-label">MR/Draft/Card No <span
                                                            class="spin-separator spin-star">*</span></td>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <button type="submit" class="btn btn-primary"><i class="icon-check2"></i>
