...
@section('heading')
Approved: Self Advertisement
@endsection

@section('approvedActive')
class="active"
@endsection
...
<ul class="nav nav-pills nav-justified mb-8">
    <li class="nav-item col-md-4">
        <a class="nav-link active" id="active-pill" data-toggle="pill" href="#active" aria-expanded="true">Approved Self Advertisement Applications</a>
    </li>
</ul>
<!-- tabs -->
    ...
    <div role="tabpanel" class="tab-pane active" id="active" aria-labelledby="active-pill" aria-expanded="true">
        <div class="card">
            <div class="card-header card-bg">
                <div class="card-title my-card-title">Self Advertisement Approved</div>
            </div>
            <div class="card-body">
