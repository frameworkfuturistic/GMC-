                                ...
                                <table id="myTable" class="table table-bordered">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" value="{{$SelfAds->EntityName}}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" value="{{$SelfAds->HoldingNo}}"
                                                    id="HoldingNo" name="HoldingNo">
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" value="{{$SelfAds->Longitude}}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" value="{{$SelfAds->Latitude}}"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="4" class="spin-label" style="width:100%;"><span>Upload
                                                    ...
                                                    name="Proceeding2Photo" type="file" accept="application/pdf,image/*"
                                                    style="width:100%;"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="4" class="spin-label" style="width:100%;"><span>Upload
                                                    Proceeding3 Photo</span><input id="Proceeding3Photo"
                                                    name="Proceeding3Photo" type="file" accept="application/pdf,image/*"
                                                    style="width:100%;">
                                            </td>
                                        </tr>
                                        <tr>
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <form class="form mb-top" method="POST"
                                action="{{url('api/rnc/InboxWorkflow/'.$SelfAds->id)}}" id="forwardTo1">
                                @method('PUT')
                                @csrf
                                <div class="form-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="scroll">
                                ...
                                <img src="{{$SelfAds->HoldingNoPath}}" alt="" style="width: 100%;" id="HoldingNoPath"
                                    name="HoldingNoPath" onclick="myfunction('forth')">
                                <br>
                                <label for="">GST Path Document Photo</label>
                                <img src="{{$SelfAds->GSTPath}}" alt="" style="width: 100%;" id="GSTPath" name="GSTPath"
                                    onclick="myfunction('fifth')">
                                <br>
