...
function to be used on Self Advertisement field
 */
...
trait SelfAdvet
{
    ...
    public function SelfAdvetInboxView()
    {
        ...
        return view('admin.SelfAdv.advetInbox', ['SelfAds' => $data]);
    }
    // WORKFLOW
    ...
    public function SelfAdvetOutboxView()
    {
        $name = Auth::user()->name;
        $data = SelfAdvertisements::where('CurrentUser', '<>', $name)->get();
        return view('admin.SelfAdv.advetOutbox', ['SelfAds' => $data]);
    }
    ...
    public function updateSelfAdvetInboxView($id)
    {
        ...
        //     return View::make('admin.updateadvetInbox')->with($array);
        // }
        // else {
        //     return 'Data Has been forwarded in outbox';
        // }
    ...
    public function paymentDash()
    {
        ...
        return view('admin.SelfAdv.advetPayment', ['SelfAds' => $data]);
    }
    ...
    public function advetApprovedView()
    {
        ...
        return view('admin.SelfAdv.advetApproved', ['SelfAds' => $data]);
    }
    ...
    public function advetRejectedView()
    {
        ...
        return view('admin.SelfAdv.advetRejected', ['SelfAds' => $data]);
    }
