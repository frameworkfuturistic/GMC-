...
trait Banquet
{
    ...
    public function banquetOutboxView()
    {
        $name = Auth::user()->name;
        $data = banquetHall::where('CurrentUser', '<>', $name)->get();
        return view('admin.Banquet.banquetOutbox', ['banquets' => $data]);
    }
    ...
    public function banquetApprovedView()
    {
        ...
        return view('admin.Banquet.banquetApproved', ['banquets' => $data]);
    }
    ...
    public function banquetBanquetView()
    {
        ...
        return view('admin.Banquet.banquetRejected', ['banquets' => $data]);
    }
