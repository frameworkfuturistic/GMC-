...
trait Dharmasalas
{
    ...
    public function dharmasalaApprovedView()
    {
        ...
        return view('admin.Dharmasala.dharmasalaApproved', ['dharmasalas' => $data]);
    }
    ...
    public function DharmasalaRejectedView()
    {
        ...
        return view('admin.Dharmasala.dharmasalaRejected', ['dharmasalas' => $data]);
    }
